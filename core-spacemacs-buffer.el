...
;;
;;; Commentary:
;; (let* ((title (propertize  'face '(:weight bold :slant reverse-italic :box "#DA3F96" :foreground "#9194D4")))
;;
;;; Code:
(defconst spacemacs-custom-logo-titles ["H E  S P O K E  O F  L A N D S  N O T  F A R\nO R  L A N D S  T H E Y  W E R E  I N  H I S  M I N D"
                                        "W I T H  H U N G E R  A T  H E R  H E E L S\nF R E E D O M  I N  H E R  E Y E S\nS H E  D A N C E S  O N  H E R  K N E E S\nP I R A T E  P R I N C E  A T  H E R  S I D E\nS T A R I N G  I N T O  T H E  H O L L O W  I D O L' S  E Y E S"
                                        "E V E N  S I B E R I A  G O E S  T H R O U G H  T H E  M O T I O N S"
                                        "O V E R  V A L L E Y S  O F  E N D L E S S  S E A S"
                                        "I  A M  T H E  L I Z A R D  K I N G"
                                        "Q U E E N  A N N E' S  R E V E N G E"
                                        "省R U N  F O R  Y O U R  L I F E省"
                                        "T R U E  S A I L I N G  I S  D E A D"
                                        "A  F E A S T  O F  F R I E N D S"
                                        "P E R S I A N  N I G H T,  B A B E"
                                        "J U S T  L I K E  T H E  S P I D E R  O N  T H E  W A L L"
                                        "L I K E  A  D O G  W I T H O U T  A  B O N E"
                                        "K I L L E R  O N  T H E  R O A D"
                                        "T H E  C O L O R  S U N  S H I N E"
                                        "P I R A T E  P R I N C E  A T  H E R  S I D E"])

(defconst spacemacs-buffer-version-info "0.300"
  "Current version used to display addition release information.")

(defconst spacemacs-buffer-name "*home buffer*"
...
BANNER: the path to an ascii banner file."
  (when (file-exists-p banner)
    (let* ((list-len (length spacemacs-custom-logo-titles))
           (title (split-string (aref spacemacs-custom-logo-titles 0) "\n"))
      ...
      (mapcar (lambda (line)
                (insert (make-string (max 0 (floor (/ (- spacemacs-buffer--window-width
                                                         (+ (length line) 1)) 2))) ?\s))
                (insert (format "%s\n" (propertize line 'face '(:weight bold :foreground "#E6C53C")))))
              title)
      (insert "\n"))))
